...
export default function CatererLoginScreen() {
  ...
  useEffect(() => {
    if (pathname !== "/caterer-login" || !isAuthenticated || !user) {
      return;
    }

    // This is the home caterer login page - only home caterers should be here
    if (user.role === "customer") {
      const handleWrongRoleLogin = async () => {
        ...
        showErrorAlert(
          "This login is for caterers only. Please use the Customer Login page.",
          () => {
      ...
      const handleWrongRoleLogin = async () => {
        ...
        // Show alert with redirect callback (no logout needed, already done)
        showErrorAlert(
          "This login is for home caterers only. Please use the Restaurant Login page.",
          () => {
      ...
      // Role matches (home caterer) - redirect to dashboard
      router.replace("/");
      setLoading(false);
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Home Kitchen Service</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          {/* Continue as Customer/Restaurant */}
